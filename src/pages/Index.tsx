...
const Index = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Easily categorize and manage all your income and expenses in one place."
    },
    {
      icon: PieChart,
    ...
    },
    {
      ...
      description: "Set and track financial goals to achieve your dreams faster."
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              Track expenses, manage budgets, and gain insights into your financial habits with our 
              beautiful and intuitive expense tracking application.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link to="/signup">
                <Button size="lg" className="bg-gradient-primary hover:bg-primary-hover px-8 py-6 text-lg">
                  Get Started Free
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="bg-gradient-card hover:shadow-lg transition-smooth group">
                <CardHeader>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join thousands of users who have taken control of their finances with our comprehensive expense tracking solution.
              </p>
            ...
            <div className="relative">
              <Card className="bg-gradient-card shadow-xl">
                <CardHeader>
                  ...
                  <CardDescription>See your financial overview at a glance</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center p-3 bg-muted/50 rounded">
                      <span>Total Balance</span>
                      <span className="font-bold text-success">$2,847.23</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-muted/50 rounded">
                      <span>This Month</span>
                      <span className="font-bold text-destructive">-$303.44</span>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Join ExpenseTracker today and start making smarter financial decisions.
          </p>
