...
import { PieChart, BarChart3, TrendingUp, Calendar, Download } from "lucide-react";
import Navigation from "@/components/layout/Navigation";

const Reports = () => {
  const categoryData = [
    { category: "Food", amount: 245.50, percentage: 35 },
    { category: "Transportation", amount: 180.20, percentage: 26 },
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <CardContent>
              <div className="h-64 bg-muted rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Connect Supabase for data</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">$159.99</p>
                </div>
        ...
        <Card className="bg-gradient-card">
          <CardHeader>
            ...
            <CardDescription>Track your progress against set budgets</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-muted rounded-full h-2">
                  <div className="bg-gradient-accent h-2 rounded-full" style={{ width: '60%' }}></div>
                </div>
              </div>
            </div>
          </CardContent>
